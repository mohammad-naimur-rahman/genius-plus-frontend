    ...
    <>
      <div className={cn(containerClassName)}>
        ...
        <div
          id={id || name}
          className={cn(
            'flex flex-col items-center justify-center rounded-2xl border-2 border-dashed bg-background p-5 text-center focus:border-4 sm:p-10',
            className
          )}
          onDrop={handleDrop}
            ...
            {file ? (
              ...
              <div className='flex flex-col items-center justify-center gap-4'>
                ...
                <div className='space-y-1'>
                  ...
                  <p className='font-medium italic text-text-gray'>{description}</p>
                </div>
              </div>
            )}
          </div>
